...
const Blog1card = (props) => {
  return (
    <div className="rounded-xl flex flex-col shadow-lg hover:-translate-y-2 transition">
      <div className="overflow-hidden group relative  ">
        <img src={props.imgurl} alt="blog image" className="w-[100%]  z-20 rounded-t-xl" />
